...
#### Over time, has there been an increase in the number of sentences spoken by POC actors in Oscar-nominated films?
...
poc_sentences_by_year %>%
  ggplot() +
  aes(x = fct_reorder(year, percent_poc_sentences, .desc = TRUE), #order years by percentage
...
There does not appear to be an upward trend in the number of lines given to POC actors across the years in oscar nominated films. Of the Oscar-nominated films in 2017, POC actors had 3.87% of the lines. In 2015, only 2.25% of lines were given to POC actors and 2.91% of lines in 1989. Overally, all of these percentages are very low and seem to vary based on the specific films being nominated that year and not by any progression of diversity.
...
#### Which year had the most even ratio of male to female actors in Oscar-nominated films? 
